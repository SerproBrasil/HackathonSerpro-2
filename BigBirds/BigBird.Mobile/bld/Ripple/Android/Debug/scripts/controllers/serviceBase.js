//var baseUrl = 'http://192.168.15.33/Magine.EscPart.WebServices/';
var baseUrl = '';
...
(function ($) {
    ...
    $.POST = function (url, data, onSuccess, onError, headers) {
        if (ConexaoController.possuiConexao()) {
          ...
          , 'complete': function (jqXHR, textStatus) {
            ...
            MensagemController.showAlerta("Por favor ative a sua conexão com a internet.");
        }
    }
    ...
    $.GET = function (url, data, onSuccess, onError, headers) {
        if (ConexaoController.possuiConexao()) {
            return $.ajax({
                'type': "GET"
          , 'url': url
    ...
    function logError(err, errorHandler, jqXHR) {
        ...
        try {
            if (errorHandler) {
                ...
                MensagemController.showAlerta("ops :`(");
            }
        } catch (e) { }
        return;
    }
